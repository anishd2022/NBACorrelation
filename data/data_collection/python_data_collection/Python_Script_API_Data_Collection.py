...
if os.path.exists(file_path):
    ...
    merged_df = existing_df.merge(new_df, on=['Player_ID', 'Name', 'Stat_Type', 'Position', 'Opponent', 'Team',
    ...
    merged_df.sort_values(['Start_Time', 'Game_ID', 'Name'], ascending=(True, True, True), inplace=True)
    print(merged_df)
